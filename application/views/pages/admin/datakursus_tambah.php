...
<form action="<?php echo base_url(). 'admin/datakursus/tambah'; ?>" method="post" name="datakursus">
<div class="mb-3">
...
<div class="mb-3">
  ...
  <textarea  class="form-control" name="keterangan_kursus" cols="30" rows="5" placeholder="Keterangan Kursus"></textarea>
